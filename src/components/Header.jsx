        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full overflow-hidden border border-stone-200 shadow">
              <img src={logo} className="w-full h-full object-cover" alt="ロゴ" />
            </div>
            <span className="text-2xl sm:text-3xl font-semibold text-amber-900 hidden sm:block">
              Craft Bakery
            </span>
          </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur text-amber-800 rounded-full hover:bg-white transition"
          >
              ...
              <button
                ...
                className={`whitespace-nowrap px-5 py-2 rounded-full text-sm font-medium transition ${
                  activeSection === cat.id
                    ...
                    : "bg-white/60 backdrop-blur text-amber-800 hover:bg-amber-100"
                }`}
              >
                {cat.name}
              </button>
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="パスワード"
              className="w-full px-4 py-3 border rounded-lg focus:border-amber-500 outline-none"
            />
